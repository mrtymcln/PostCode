...
This source code is made publicly available for reference and transparency only. It is not open source, and no open-source licence is granted.

**You may** view the source code for personal or educational purposes.

**You may not** use the source code — in whole or in part — in your own projects; copy, modify, distribute, sublicense, or sell it or any derivative; publish it or any derivative to the App Store or any other channel; or use the PostCode name or icon.

The compiled application is distributed exclusively through [Apple's App Store](https://apps.apple.com/app/id6758260094), under the [Licensed Application EULA](https://apple.com/legal/internet-services/itunes/dev/stdeula/).

The software is provided 'as is', without warranty of any kind. For permissions beyond the scope of this licence, please contact the copyright holder.
